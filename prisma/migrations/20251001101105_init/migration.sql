...
-- CreateEnum
CREATE TYPE "public"."AdvancedBookingStatus" AS ENUM ('OPEN', 'CLOSED', 'ACCEPTED', 'SCHEDULED', 'COMPLETED', 'CANCELED', 'WON', 'LOST');
...
CREATE TABLE "public"."Driver" (
    ...
    "specificMusic" BOOLEAN NOT NULL DEFAULT false,
