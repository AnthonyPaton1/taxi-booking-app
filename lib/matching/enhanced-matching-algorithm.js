...
function meetsVehicleRequirement(driver, booking) {
  ...
  const wheelchairCount = wheelchairConfig.count || 0;
  ...
  const requiresDoubleWAV = wheelchairConfig.requiresDoubleWAV || false;
  const requiresRearLoading = wheelchairConfig.requiresRearLoading || false;
  const requiresSideLoading = wheelchairConfig.requiresSideLoading || false;
